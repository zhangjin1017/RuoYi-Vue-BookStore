<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="封面" align="center" prop="picture" width="100">
      ...
      <el-table-column label="分类" align="center" prop="bookClass" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="分类" prop="bookClass">
          <el-input v-model="form.bookClass" placeholder="请输入分类" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('book/book/export', {
        ...this.queryParams
